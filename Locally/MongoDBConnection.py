...
def QueryDatabase():
    ...
    try:
        ...
        roadA = (oldSensorData[length+0]["Roads"]["TRAFFIC SENSOR"] + oldSensorData[length+3]["Roads"]["TRAFFIC SENSOR"] +
                 oldSensorData[length+6]["Roads"]["TRAFFIC SENSOR"]) // 3
        roadB = (oldSensorData[length+1]["Roads"]["TRAFFIC SENSOR"] + oldSensorData[length+4]["Roads"]["TRAFFIC SENSOR"] +
                 oldSensorData[length+7]["Roads"]["TRAFFIC SENSOR"]) // 3
        roadC = (oldSensorData[length+2]["Roads"]["TRAFFIC SENSOR"] + oldSensorData[length+5]["Roads"]["TRAFFIC SENSOR"] +
                 oldSensorData[length+8]["Roads"]["TRAFFIC SENSOR"]) // 3
